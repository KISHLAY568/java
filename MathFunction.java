...
public class MathFunction {
    ...
    public static void main(String[] args) {
        ...
        // 3c. Rounding to the closest integer. 2.1 -> 2, 2.9 -> 3, 2.5 -> (even
        // integer), 3.5 (4)

        System.out.println(Math.rint(2.5)); // 2
        System.out.println(Math.rint(3.5)); // 4

        // 3d. Round function : (int)(Math.floor(x + 0.5) -> float
        // (long)(Math.floor(x + 0.5) -> double

        System.out.println(Math.round(-2.0f)); // -2.0 + 0.5 -> -1.5 -> -2.0 -> -2
        System.out.println(Math.round(-2.6)); // -2.6 + 0.5 -> -2.1 -> -3.0 -> -3
